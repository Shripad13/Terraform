...
## 📌 What is the .id for a null_resource?
3124463707456042348

The id of a null_resource is a random-looking number like:
Internally generated by Terraform.
Used to track the state of the null_resource in the .tfstate file.
Not something you define or control. & Not related to any AWS resource — just Terraform metadata.

## 🔍 What is a null_resource in Terraform?

A null_resource is a placeholder resource that does nothing on its own. It's often used to:
